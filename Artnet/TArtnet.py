...
if __name__ == '__main__':
    print("===================================")
    print("Namespace run")
    TARGET_IP = '169.254.44.100'         # typically in 2.x or 10.x range
    UNIVERSE_TO_SEND = 15           # see docs
    PACKET_SIZE = 20                # it is not necessary to send whole universe

    source_ip = "169.254.44.1"  # Replace with your machine’s link-local IP
    a = StupidArtnet(TARGET_IP, UNIVERSE_TO_SEND, PACKET_SIZE, source_address=(source_ip, 0), artsync=True)
